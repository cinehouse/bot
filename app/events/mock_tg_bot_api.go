...
// MockTgBotAPI is an autogenerated mock type for the TgBotAPI type
type MockTgBotAPI struct {
	mock.Mock
}

// GetUpdatesChan provides a mock function with given fields: config
func (_m *MockTgBotAPI) GetUpdatesChan(config tgbotapi.UpdateConfig) tgbotapi.UpdatesChannel {
...
func (_m *MockTgBotAPI) Send(c tgbotapi.Chattable) (tgbotapi.Message, error) {
	ret := _m.Called(c)
